"""Simple command line interface for AWS IDS Testbed 07."""
...
from aws_ids_testbed_07.victim_capture_service import (
    deploy_victim_capture,
    verify_victim_capture,
    victim_capture_scenario,
    victim_list_pcaps,
)
from aws_ids_testbed_07.victim_capture_agent_service import (
...
from aws_ids_testbed_07.victim_config_service import (
    configure_victim_ids_url,
    victim_set_scenario,
    victim_verify_ids_url,
)
from aws_ids_testbed_07.victim_sender_service import (
    deploy_victim_sender,
    verify_victim_sender,
    victim_send_pcap,
    victim_send_pending_pcaps,
)
from aws_ids_testbed_07.victim_sender_agent_service import (
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="AWS IDS Testbed 07 controller")
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli show-inventory
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli create-victim
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli create-attacker
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli create-ids
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli setup-victim
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli setup-attacker
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli setup-ids
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli capture-benign-http
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli verify-benign-pcap
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli generate-benign-http
    ...
    #   python3 -m aws_ids_testbed_07.cli generate-traffic 1 --requests 100 --concurrency 5
    #   python3 -m aws_ids_testbed_07.cli generate-traffic 2 --requests 1000 --concurrency 50
    #   python3 -m aws_ids_testbed_07.cli generate-traffic 3 --packet-count 1000 --port 80
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli configure-attacker-victim-url
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli attacker-verify-victim-url
    ...
    # It reads the attacker public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli deploy-attacker-traffic
    ...
    # It reads the attacker public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli verify-attacker-traffic
    ...
    #   3 = controlled DoS SYN flood
    # Terminal command examples:
    #   python3 -m aws_ids_testbed_07.cli attacker-generate-traffic 1
    #   python3 -m aws_ids_testbed_07.cli attacker-generate-traffic 2 --requests 1000 --concurrency 50
    #   python3 -m aws_ids_testbed_07.cli attacker-generate-traffic 3 --packet-count 100 --port 80
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli run-scenario 1 --requests 100 --concurrency 5
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli deploy-ids-receiver
    ...
    # It reads the IDS public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli ids-start-receiver
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli configure-victim-ids-url
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-verify-ids-url
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-set-scenario benign_http
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli deploy-victim-sender
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli verify-victim-sender
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-send-pcap --pcap-path PATH --scenario LABEL
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-send-pending-pcaps
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli deploy-victim-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli verify-victim-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-start-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-stop-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-sender-agent-status
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-start-agents
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-stop-agents
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-agents-status
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli deploy-victim-capture
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli verify-victim-capture
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-capture-scenario --scenario LABEL --seconds 20
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-list-pcaps
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli deploy-victim-capture-agent
    ...
    # It checks that the script exists, is executable, and has valid bash syntax.
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli verify-victim-capture-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-start-capture-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-stop-capture-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_07.cli victim-capture-agent-status
