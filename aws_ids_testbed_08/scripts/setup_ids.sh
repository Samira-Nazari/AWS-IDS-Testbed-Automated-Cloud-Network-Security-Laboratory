...
echo "[ids] Installing PyTorch CPU runtime for model inference..."
"$HOME/aws_ids_testbed/ids_env/bin/python" -m pip install --index-url https://download.pytorch.org/whl/cpu torch
