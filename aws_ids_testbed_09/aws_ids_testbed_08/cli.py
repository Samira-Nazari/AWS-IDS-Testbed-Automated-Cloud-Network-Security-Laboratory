"""Simple command line interface for AWS IDS Testbed 08."""
...
from aws_ids_testbed_08.attacker_config_service import (
    attacker_verify_victim_url,
    configure_attacker_victim_url,
)
from aws_ids_testbed_08.attacker_traffic_service import (
...
from aws_ids_testbed_08.ids_receiver_service import (
    deploy_ids_receiver_files,
    ids_list_received_pcaps,
    ids_start_receiver,
)
from aws_ids_testbed_08.ids_csv_download_service import download_ids_csv_files
from aws_ids_testbed_08.ids_pcap_converter_service import (
...
from aws_ids_testbed_08.victim_capture_agent_service import (
...
from aws_ids_testbed_08.victim_sender_service import (
    deploy_victim_sender,
    verify_victim_sender,
    victim_send_pcap,
    victim_send_pending_pcaps,
)
from aws_ids_testbed_08.victim_sender_agent_service import (
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="AWS IDS Testbed 08 controller")
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli show-inventory
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli create-victim
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli create-attacker
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli create-ids
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli setup-victim
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli setup-attacker
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli capture-benign-http
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli verify-benign-pcap
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli generate-benign-http
    ...
    #   python3 -m aws_ids_testbed_08.cli generate-traffic 1 --requests 100 --concurrency 5
    #   python3 -m aws_ids_testbed_08.cli generate-traffic 2 --requests 1000 --concurrency 50
    #   python3 -m aws_ids_testbed_08.cli generate-traffic 3 --packet-count 1000 --port 80 --interval-microseconds 5000
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli configure-attacker-victim-url
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli attacker-verify-victim-url
    ...
    # It reads the attacker public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli deploy-attacker-traffic
    ...
    # It reads the attacker public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli verify-attacker-traffic
    ...
    #   3 = controlled DoS SYN flood
    # Terminal command examples:
    #   python3 -m aws_ids_testbed_08.cli attacker-generate-traffic 1
    #   python3 -m aws_ids_testbed_08.cli attacker-generate-traffic 2 --requests 1000 --concurrency 50
    #   python3 -m aws_ids_testbed_08.cli attacker-generate-traffic 3 --packet-count 1000 --port 80 --interval-microseconds 5000
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli run-scenario 1 --requests 100 --concurrency 5
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli deploy-ids-receiver
    ...
    # It reads the IDS public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-start-receiver
    ...
    # It reads the IDS public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-list-received-pcaps
    ...
    # It reads the IDS public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli deploy-ids-pcap-converter
    ...
    # It reads the IDS public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli verify-ids-pcap-converter
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-start-pcap-converter-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-stop-pcap-converter-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-pcap-converter-agent-status
    ...
    # It reads the IDS public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-list-csv-files
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-download-csv-files
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-run-inference-step1
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-run-inference-step2
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-run-inference-step4
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-debug-inference-artifacts
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-debug-feature-distribution
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-debug-prediction-probabilities
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-debug-compare-lite-v6-classes
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-convert-pcap --pcap-path PATH
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli ids-convert-received-pcaps
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli configure-victim-ids-url
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-verify-ids-url
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-set-scenario benign_http
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli deploy-victim-sender
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli verify-victim-sender
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-send-pcap --pcap-path PATH --scenario LABEL
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-send-pending-pcaps
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli deploy-victim-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli verify-victim-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-start-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-stop-sender-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-sender-agent-status
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-start-agents
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-stop-agents
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-agents-status
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli deploy-victim-capture
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli verify-victim-capture
    ...
    # It reads the victim public IP from inventory.yaml.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-capture-scenario --scenario LABEL --seconds 20
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli deploy-victim-capture-agent
    ...
    # It checks that the script exists, is executable, and has valid bash syntax.
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli verify-victim-capture-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-start-capture-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-stop-capture-agent
    ...
    # Terminal command:
    #   python3 -m aws_ids_testbed_08.cli victim-capture-agent-status
