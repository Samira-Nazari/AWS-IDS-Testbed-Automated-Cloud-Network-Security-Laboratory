...
# Model and preprocessing artifacts used by normal IDS inference.
# Keep the existing LITE_V6_* names for compatibility with the inference code,
# but load their values from the Lite V9 project bundled in this testbed.
LITE_V9_TRAINED_PROJECT_ROOT = PROJECT_ROOT / "Lite_V9_CICIoT2023"
LITE_V9_TRAINED_OUTPUTS_DIR = LITE_V9_TRAINED_PROJECT_ROOT / "outputs"

# Original Lite V6 train/validation/test arrays are retained only for the
# optional ids-debug-compare-lite-v6-classes diagnostic command.
...
LITE_V6_MODEL_PATH = LITE_V9_TRAINED_OUTPUTS_DIR / "models" / "best_model.pt"
LITE_V6_MODEL_CONFIG_PATH = (
    LITE_V9_TRAINED_OUTPUTS_DIR / "models" / "model_config.json"
)
LITE_V6_LABEL_ENCODER_PATH = (
    LITE_V9_TRAINED_OUTPUTS_DIR / "models" / "label_encoder.pkl"
)

LITE_V6_SELECTED_FEATURES_PATH = (
    LITE_V9_TRAINED_OUTPUTS_DIR / "data" / "selected_features.pkl"
)
LITE_V6_STANDARD_SCALER_PATH = (
    LITE_V9_TRAINED_OUTPUTS_DIR / "data" / "standard_scaler.pkl"
)
LITE_V6_WINDOW_CONFIG_PATH = (
    LITE_V9_TRAINED_OUTPUTS_DIR / "data" / "window_config.pkl"
)
LITE_V6_LABEL_CLASSES_PATH = (
    LITE_V9_TRAINED_OUTPUTS_DIR / "data" / "label_classes.pkl"
)
