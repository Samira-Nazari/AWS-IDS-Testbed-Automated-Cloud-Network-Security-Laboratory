...
class Feature_extraction():
    columns = ["ts","Header_Length","Protocol Type","Time_To_Live","Rate", 
        ...
        "src_port", "dst_port", "ethernet_frame_type", "src_byte_count", "dst_byte_count",
        "src_pkts", "dst_pkts", "connection_status", "number_of_packets_per_trabsaction",
        "flow_byte", "flow_duration", "max_duration", "min_duration", "sum_duration",
        "average_duration", "std_duration", "idle_time", "active_time", "src_to_dst_pkt",
        "dst_to_src_pkt", "src_to_dst_byte", "dst_to_src_byte", "srate", "drate",
        "urg_count", "mqtt", "coap", "mac", "rarp", "type_info", "sub_type_info",
        "sequence", "pack_id", "fragments", "wifi_dur"]
    ...
    def pcap_evaluation(self,pcap_file,csv_file_name):
            ...
            if eth.type == dpkt.ethernet.ETH_TYPE_IP or eth.type == dpkt.ethernet.ETH_TYPE_ARP:
                ...
                new_row = {
                          ...
                          "cwr_flag_number":flag_valus[7],      
                           ...
                           "number_of_packets_per_trabsaction": number_of_packets_per_trabsaction,
                           "flow_byte": flow_byte,
                           ...
                           "src_to_dst_pkt": src_to_dst_pkt,
                           "dst_to_src_pkt": dst_to_src_pkt,
                           "src_to_dst_byte": src_to_dst_byte,
                           "dst_to_src_byte": dst_to_src_byte,
                           "srate": srate,
                           "drate": drate,
                           "urg_count": urg_count,
                           "mqtt": mqtt,
        ...
        while last_row<len(processed_df):
            ...
            timestamp_start = sliced_df['ts'].min()
            timestamp_end = sliced_df['ts'].max()
            timestamp_mean = sliced_df['ts'].mean()
            ...
            if duration_time_interval == 0:
                sliced_df['Rate'] = 0
            else:
                sliced_df['Rate'] = num_of_packets/duration_time_interval
            sliced_df['Variance'] = variance_packet_lengths
            sliced_df['Timestamp_Start'] = timestamp_start
            sliced_df['Timestamp_End'] = timestamp_end
            sliced_df['Timestamp_Mean'] = timestamp_mean
